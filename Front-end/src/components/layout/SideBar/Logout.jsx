...
export default function Logout({ onClick }) {
    return (
        <button
            ...
            className="w-full flex items-center bg-indigo-950 rounded px-4 py-3 font-light text-sm text-zinc-50 gap-3 cursor-pointer hover:bg-indigo-900 transition-colors duration-200 ease-in mt-auto"
