...
export default function CategoryCard({ category }) {
    ...
    return (
        <div className="flex items-center justify-between p-5 bg-(--light-bg-category-card) dark:bg-(--dark-bg-category-card) rounded-2xl border border-(--light-border-color) dark:border-(--dark-border-color)">
