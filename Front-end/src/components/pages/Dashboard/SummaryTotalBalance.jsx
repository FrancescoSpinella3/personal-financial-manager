...
export default function SummaryTotalBalance() {
    return (
        <ContainerItem 
            hideLink
            className="bg-linear-65 from-(--light-bg-main-color) to-zinc-100 dark:bg-(--dark-bg-color) rounded-md"
        >
            <div className="flex flex-col justify-start p-5">
                ...
                {/* Balance cards */}
                <div className="w-full bg-(--light-bg-container) dark:bg-(--dark-bg-container) p-3 rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-3 w-full">
                        ...
                        <ContainerSummaryBalance
                            ...
                            className="border-l-2 pl-5 border-(--light-border-color) dark:border-(--dark-border-color)"
                        />
                        {/* Total Saves */}
                        <ContainerSummaryBalance
